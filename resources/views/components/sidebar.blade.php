<div class="col-lg-4 col-xl-3 sidebar px-1">
    <div class="d-flex flex-column h-100">
        <ul class="nav nav-tabs pt-2 px-2 mb-1" id="sidebarTab" role="tablist">
            <li class="nav-item flex-fill" role="presentation">
                <button class="nav-link active w-100" id="companies-tab" data-bs-toggle="tab" data-bs-target="#companies"
                    type="button" role="tab">All Companies</button>
            </li>
            <li class="nav-item flex-fill" role="presentation">
                <button class="nav-link w-100" id="watchlist-tab" data-bs-toggle="tab" data-bs-target="#watchlist"
                    type="button" role="tab">Watchlist</button>
            </li>
        </ul>
        <div class="px-2 pb-2">
            <input class="form-control search-input" type="search" placeholder="Search Company Name">
        </div>
