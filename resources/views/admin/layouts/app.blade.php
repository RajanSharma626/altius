...
<head>
    ...
    <style>
        body {
            background: linear-gradient(180deg, #f4f7fb 0%, #eef5fb 40%, #eaf8f2 100%);
        }
        ...
        .welcome-card {
            background: linear-gradient(120deg, #f0f7ff 0%, #f9fbff 55%, #f0fff6 100%);
        }
            ...
            <div class="menu-header">
                <span>
                    <a class="navbar-brand" href="{{ route('admin.dashboard') }}">
                        <h5 class="fw-bold mb-0">Bridging Gap</h5>
                    </a>
                ...
                <div class="menu-content-wrap">
                    <div class="menu-group">
                        <ul class="navbar-nav flex-column">
                            <li
                                class="nav-item mb-2 {{ Route::currentRouteNamed('admin.dashboard') ? 'active' : '' }}">
                            ...
                            <li class="nav-item mb-2 {{ Route::is('admin.companies.*') ? 'active' : '' }}">
                            ...
                            <li class="nav-item mb-2 {{ Route::is('admin.users.*') ? 'active' : '' }}">
                                    ...
                                    <span class="nav-icon-wrap">
                                        <span class="svg-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <path d="M15 21v-2a4 4 0 0 0 -3 -3.85" />
                                            </svg>
                                        </span>
                                    </span>
